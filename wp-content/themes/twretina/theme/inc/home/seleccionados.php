...
function retlat_html_seleccionados($contenidos) {
    ...
    foreach ($contenidos as $cont) {
        ...
        if (!get_the_post_thumbnail($cont)) {
            $imagenBlog = '<img class="rounded-xl block mx-auto" src=' . get_stylesheet_directory_uri() . '/assets/images/no-destacada.png" width="300" height="215px">';
        } else {
    ...
    <a href="<?php echo get_post_permalink($cont); ?>" class="">
        ...
        <div class="relative bg-gradient-to-b from-rl-moramedio to-rl-morafuerte p-4 rounded-xl">
            ...
            <div class="flex flex-col  justify-between">
                <?php echo $imagenBlog; ?>
                <img class="opacity-80 absolute top-5 left-5"
                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/triangulo-blanco-mini.svg" alt="">
