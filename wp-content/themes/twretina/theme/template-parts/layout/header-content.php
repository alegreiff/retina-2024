...
<header id="masthead" class=" bg-pink-500">
    ...
    <header class="container mx-auto md:flex md:justify-between md:items-center md:px-4 md:py-3">
        <div class="flex items-start justify-between px-4 py-3 md:p-0">
            ...
            <div class="md:hidden">
                <button type="button block"
                    class="rl_menu_button text-fugamora-dark focus:text-fugamora-dark focus:outline-none hover:text-fugaazul ">
                    <svg class="w-8 h-8 fill-current" viewBox="0 0 24 24">

                        <path id="pathid1" fill-rule="evenodd"
        ...
        <div class="hidden md:block rl_menu_header">
            <?php
