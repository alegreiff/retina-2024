(() => {
  ...
  (() => {
    jQuery(function($) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          datos.registros > 0 ? $("#rl_maincategory").html(datos.categoriaprincipal) : $("#rl_maincategory").html("");
          $("#totales").html(
            "Pel\xEDculas disponibles: " + datos.registros + " - " + datos.paginasresultado
          );
    ...
    var checkeoBoton = (cuantaspelis, pelisporpagina) => {
      ...
      restantes = parseInt(cuantaspelis) - parseInt(page) * parseInt(pelisporpagina);
      ...
      boton.onclick = () => {
        const restantes2 = parseInt(cuantaspelis) - (parseInt(page) + 1) * parseInt(pelisporpagina);
        if (restantes2 > 0) {
